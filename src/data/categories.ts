...
export const categories: MarketplaceCategory[] = [
  ...
  },
  {
    ...
    subcategories: [
      subcategory("T-Shirts", "/category-pages/men/shop-by-category/tshirt.jpg", ["Printed T-Shirts", "Plain T-Shirts", "Polo T-Shirts", "Oversized T-Shirts"]),
      subcategory("Shirts", "/category-pages/men/shop-by-category/shirt.jpg", ["Casual Shirts", "Formal Shirts", "Printed Shirts"]),
      subcategory("Jeans", "/category-pages/men/shop-by-category/jeans.jpg", ["Slim Fit Jeans", "Regular Fit Jeans", "Skinny Jeans", "Straight Fit Jeans"]),
      subcategory("Footwear", "https://images.unsplash.com/photo-1614252339474-ce3a484c2eb5?auto=format&fit=crop&w=600&q=80", ["Casual Shoes", "Sneakers", "Loafers", "Sandals", "Boots", "Sports Shoes", "Formal Shoes"]),
      subcategory("Winter Wear", "/category-pages/men/shop-by-category/winterwear.jpg", ["Jackets", "Sweaters", "Sweatshirts", "Hoodies"]),
      subcategory("Formal Wear", "/category-pages/men/shop-by-category/formalwearr.jpg", ["Suits", "Blazers", "Formal Trousers", "Formal Shirts"]),
      subcategory("Ethnic Wear", "/category-pages/men/shop-by-category/etenic.jpg", ["Kurtas", "Kurta Sets", "Sherwanis", "Nehru Jackets", "Dhotis"]),
      subcategory("Watches", "https://images.unsplash.com/photo-1524592094714-0f0654e20314?auto=format&fit=crop&w=600&q=80", ["Analog Watches", "Digital Watches", "Smartwatches", "Chronograph"]),
      subcategory("Bags & Wallets", "https://images.unsplash.com/photo-1627123424574-724758594e93?auto=format&fit=crop&w=600&q=80", ["Backpacks", "Wallets", "Messenger Bags", "Duffel Bags"]),
      subcategory("Accessories", "https://images.unsplash.com/photo-1511499767150-a48a237f0083?auto=format&fit=crop&w=600&q=80", ["Sunglasses", "Belts", "Caps", "Ties", "Cufflinks"]),
      subcategory("Grooming", "/category-pages/men/shop-by-category/grooming.jpg", ["Beard Care", "Skin Care", "Fragrances", "Hair Care"]),
      subcategory("Sports & Fitness", "/category-pages/men/shop-by-category/sportfitness.jpg", ["Active T-Shirts", "Track Pants", "Shorts", "Gym Accessories"]),
    ],
  },
  {
    name: "Kids",
