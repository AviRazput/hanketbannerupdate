...
export const homeCategories = [
  {
    slug: "summer-escape",
    label: "SUMMER ESCAPE",
    tagline: "Effortless styles for sun-soaked days",
  ...
  },
  {
    slug: "wedding-guest",
    label: "WEDDING GUEST",
    tagline: "Modern looks for every celebration",
  ...
  },
  {
    slug: "everyday-edit",
    label: "EVERYDAY EDIT",
    tagline: "Elevated essentials for every day",
    href: "/search?tag=everyday-edit",
    image: "/catogery/kids.jpg",
  },
  {
    slug: "resort-stories",
    label: "RESORT STORIES",
    tagline: "Relaxed silhouettes made for getaways",
    href: "/search?tag=resort-stories",
    image: "/catogery/glam.jpg",
  },
  {
    slug: "festive-edit",
    label: "FESTIVE EDIT",
    tagline: "Contemporary pieces for the season",
  ...
  },
  {
    ...
    tagline: "Bold pieces for your everyday wardrobe",
    href: "/search?tag=city-statement",
